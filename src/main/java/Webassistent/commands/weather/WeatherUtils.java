...
/**
 * Helpful utils for weather commands.
 */
public class WeatherUtils {
     ...
     * @return url to the Yahoo REST-API depending on the given city name
     */
    public static String getUrlOfGivenCity(String cityName) {
    ...
    /**
     * Returns the icon depending on the given weatherConditionId
     * @param weatherConditionId the id from the yahoo api
     * @return the css of the weather icon
     */
    public static String getClassAttributeFrom(int weatherConditionId) {
        String icon = "";
